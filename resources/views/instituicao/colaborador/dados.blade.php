                ...
                <div class="block-content">
                    ...
                    <div class="block-content tab-content overflow-hidden">
                        <div
                            ...
                            <form method="post" action="{{ isset($colaborador) ? route('colaborador.update', $colaborador->id) : route('colaborador.store') }}" enctype="multipart/form-data">
                                @csrf
                                @if(isset($colaborador))
                                    @method('PUT')
                                @endif
                                <div class="row">
                                    <div class="col-sm-6 col-xs-12 mb-4">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" value="{{ isset($colaborador) ? $colaborador->user->name : '' }}" required autofocus placeholder="Nome do colaborador">
                                    </div>
                                    <div class="col-sm-6 col-xs-12 mb-4">
                                        <label class="form-label" for="last_name">Sobrenome</label>
                                        <input type="text" class="form-control" id="last_name" name="last_name" value="{{ isset($colaborador) ? $colaborador->user->last_name : '' }}" required placeholder="Sobrenome do colaborador">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 mb-4">
                                        <label class="form-label" for="email">E-mail</label>
                                        <input type="email" class="form-control" id="email" name="email" value="{{ isset($colaborador) ? $colaborador->user->email : '' }}" required placeholder="Endereço de e-mail">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3 col-xs-12 mb-4">
                                        ...
                                        <span class="input-group-text">
                                          <i class="fa fa-user-lock"></i>
                                            ...
                                            <input type="password" class="form-control" id="password" name="password" required autocomplete="off" placeholder="Nova senha">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-xs-12 mb-4">
                                        ...
                                        <span class="input-group-text">
                                          <i class="fa fa-user-lock"></i>
                                            ...
                                            <input type="password" class="form-control" id="confirm_password" name="confirm_password" required autocomplete="off" placeholder="Confirmar nova senha">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-xs-12 mb-4">
                                        <label class="form-label" for="cargo">Cargo</label>
                                        <select class="js-select2 form-select" id="cargo" name="cargo" style="width: 100%;" required data-placeholder="Selecione...">
                                            <option value=""></option>
                                            @foreach($cargos as $cargo)
                                                <option value="{{ $cargo }}" {{(isset($colaborador) && $cargo == $colaborador->cargo) ? 'selected' : ''}}>{{ $cargo }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-3 col-xs-12 mb-4">
                                        <label class="form-label" for="data_nascimento">Data de nascimento</label>
                                        <input type="text" class="js-datepicker form-control" id="data_nascimento" value="{{ isset($colaborador) ? $colaborador->data_nascimento->format('d/m/Y') : '' }}" name="data_nascimento" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2 col-sx-12 mb-4">
                                        <label class="form-label" for="cep">Cep</label>
                                        <input type="tel" class="form-control" id="cep" name="cep" value="{{ $endereco->cep }}" readonly>
                                    </div>
                                    <div class="col-md-2 col-sx-12 mb-4">
                                        <label class="form-label" for="tipo_logradouro">Tipo</label>
                                        <input type="text" class="form-control" id="tipo_logradouro" name="tipo_logradouro" value="{{ $endereco->tipo_logradouro }}" readonly>
                                    </div>
                                    ...
                                    <div class="col-md-2 col-sx-12 mb-4">
                                        ...
                                        <input type="text" class="form-control" id="numero_endereco" name="numero_endereco" value="{{ isset($colaborador) ? $colaborador->numero_endereco : '' }}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-sx-12 mb-4">
                                        ...
                                        <input type="text" class="form-control" id="cidade" name="cidade" value="{{ $endereco->cidade }}" readonly>
                                    </div>
                                    <div class="col-md-2 col-sx-12 mb-4">
                                ...
                                <div class="row">
                                    <div class="col-12 mb-4">
                                        ...
                                        @if(isset($colaborador))
                                            <a href="{{ route('colaborador.buscarEndereco', $colaborador->id) }}" class="btn btn-lg btn-secondary">
                        ...
                        @if(isset($colaborador))
                            <div class="tab-pane fade fade-left" id="btabs-animated-slideleft-telefones" role="tabpanel" aria-labelledby="btabs-animated-slideleft-telefones-tab">
                                <form method="post" action="{{ route('colaborador.telefone.store', $colaborador->id) }}" enctype="application/x-www-form-urlencoded">
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-4">
                                            ...
                                            <div class="input-group">
                                                <input type="tel" class="form-control" id="telefone" name="numero_telefone" value="" required placeholder="(##) ####-####">
                                ...
                                <div class="row">
                                    <table class="table table-vcenter table-striped table-hover table-responsive">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="2">Nenhum número registrado ainda</td>
                                            </tr>
                                        @endforelse
                                        </tbody>
                                    </table>
